...
/**
 * Created by maidinh on 13/4/2016.
 */
public class FaceOverlayViewForSizeOther extends ImageView {

    private Bitmap mBitmap;
    private SparseArray<Face> mFaces;

    public FaceOverlayViewForSizeOther(Context context) {
        this(context, null);
    }

    public FaceOverlayViewForSizeOther(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FaceOverlayViewForSizeOther(Context context, AttributeSet attrs, int defStyleAttr) {
...
//            drawFaceBox(canvas, scale);
    ...
    private double drawBitmap(Canvas canvas) {
        ...
        int size = (int) getResources().getDimension(R.dimen.size_img_100);
