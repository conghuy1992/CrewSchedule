...
public class Utils {
    ...
    private static NetworkInfo getNetworkInfo() {
        ConnectivityManager connectivityManager = (ConnectivityManager) CrewScheduleApplication.getInstance().getApplicationContext().getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static String getString(int stringID) {
        return CrewScheduleApplication.getInstance().getApplicationContext().getResources().getString(stringID);
    }
    ...
    public static int getDimenInPx(int id) {
        return (int) CrewScheduleApplication.getInstance().getApplicationContext().getResources().getDimension(id);
    }
    ...
    public static List<DrawerDto> listDrawer() {
        DrawerDto dto;
        List<DrawerDto> list = new ArrayList<>();
        dto = new DrawerDto(R.string.string_agenda, R.drawable.menu_left_ic_agenda, Statics.DRAWER_MENU_ID_AGENDA);
        list.add(dto);
        dto = new DrawerDto(R.string.string_day, R.drawable.menu_left_ic_day, Statics.DRAWER_MENU_ID_DAY);
        list.add(dto);
        dto = new DrawerDto(R.string.string_week, R.drawable.menu_left_ic_week, Statics.DRAWER_MENU_ID_WEEK);
        list.add(dto);
        dto = new DrawerDto(R.string.string_month, R.drawable.menu_left_ic_month, Statics.DRAWER_MENU_ID_MONTH);
        list.add(dto);
        dto = new DrawerDto(R.string.string_all_calendar, Statics.DRAWER_MENU_ID_ALL_CALENDAR);
        list.add(dto);
        dto = new DrawerDto(R.string.string_public_calendar, Statics.DRAWER_MENU_ID_PUBLIC_CALENDAR);
        list.add(dto);
        dto = new DrawerDto(R.string.string_private_calendar, Statics.DRAWER_MENU_ID_PRIVATE_CALENDAR);
        list.add(dto);
        dto = new DrawerDto(R.string.string_share_calendar, Statics.DRAWER_MENU_ID_SHARE_CALENDAR);
        list.add(dto);
//        dto = new DrawerDto(R.string.dday, Statics.DRAWER_MENU_ID_DDAY);
//        list.add(dto);
        return list;
    }
}
